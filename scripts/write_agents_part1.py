#!/usr/bin/env python3
"""Part 1: Write the header and helper functions to agents.py"""
import os

script_dir = os.path.dirname(os.path.abspath(__file__))
project_root = os.path.dirname(script_dir)
agents_path = os.path.join(project_root, 'app', 'agents.py')
...
def _get_policy_concepts(evidence: list[dict]) -> dict:
    """Extract key policy concepts from retrieved evidence for decision making."""
...
print(f"Part 1 written to {agents_path}: {len(header)} chars")